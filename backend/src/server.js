...
const PaathRouter = require('./routes/PaathRoute')
const BookedSlotRouter = require('./routes/BookSlotRoute')
...
app.use('/paath',PaathRouter)
app.use('/bookpaathslot', BookedSlotRouter)
